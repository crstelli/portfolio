...
Lumina-Tech is a **fully static, design-focused SSG website** crafted to showcase a fictional tech company.  
...
3. **About Section**  
   Provides an overview of Lumina-Tech with a secondary hero layout and basic frontend components that highlight simplicity and clarity.
...
6. **Wizard Component (3 Steps)**  
   A simple but effective multi-step UI explaining the company’s process:
...
Lumina-Tech allowed me to focus entirely on **frontend craftsmanship**, reinforcing my ability to build polished, responsive, visually coherent interfaces.
